...
with st.expander("Данные о квартире", expanded = True): # expanded=True означает, что по умолчанию вкладка открыта
...
with st.expander("Данные о доме", expanded = True): # expanded=False означает, что по умолчанию вкладка закрыта
