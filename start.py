...
st.info("Данный сайт представляет собой прогноз стоимости квартиры по введённым параметрам.  \n Разработан студентами 147 группы мех-мата СГУ:  \n Володиным Максимом Сергеевичем и Трибис Инной Александровной.")
...
with st.expander("Информация о доме", expanded = True): # expanded=False означает, что по умолчанию вкладка закрыта
  ...
  if selected_address:
           ...
           building_details['FullAddress'] = building_details['Тип улицы'] + " " + building_details['Адрес']
...
st.info("Если Вы не обнаружили интересующий дом в списке или обнаружили какие-то неточности, то напишите об этом:  \n max596v@gmail.com  \n innatribis8670@gmail.com")
